    ...
    <div className="card">
      {card.urlToImage ? (
        <div id="product_image">
          <img src={card.urlToImage} alt="food" />
        </div>
      ) : (
        <div id="product_image">
          <img src={defaulImage} alt="food" />
        </div>
      )}
        ...
        <div className="modal-content">
          {card.urlToImage ? (
            <div className="modal_image">
              <img src={card.urlToImage} alt="food" id="image" height="350px" />
            </div>
          ) : (
            <div className="modal_image">
              <img src={defaulImage} alt="food" id="image" height="350px" />
            </div>
          )}

          <div id="buttons">
            {card.facebook.includes("facebook") ? (
            ...
            <div className="reserve">
              <a id="reserve" href={`${"tel:" + card.phone}`}>
                Reserve Table
              </a>
            </div>
            <div className="map">
